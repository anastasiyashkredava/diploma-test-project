...
class TestRegisterPage:
    ...
    def test_first_name_missing(self, driver):
    ...
    @allure.story('Missing required fields')
    def test_last_name_missing(self, driver):
        register_page = RegisterPage(driver)
        register_page.open_page()
    ...
    @allure.story('Missing required fields')
    def test_email_missing(self, driver):
        register_page = RegisterPage(driver)
        register_page.open_page()
        register_page.enter_first_name(register_page.first_name)
    ...
    @allure.story('Missing required fields')
    def test_timezone_not_selected(self, driver):
        register_page = RegisterPage(driver)
        register_page.open_page()
        register_page.enter_first_name(register_page.first_name)
        register_page.enter_last_name(register_page.last_name)
    ...
    @allure.story('Password does not meet the requirements')
    @pytest.mark.parametrize(
        'password',
        ['a' * 6, 'a' * 16, 'testtest', 'TESTTEST', 'testTEST', '1234567', 'test123', 'TEST123']
    )
    def test_invalid_password(self, driver, password):
        register_page = RegisterPage(driver)
        register_page.open_page()
        register_page.enter_first_name(register_page.first_name)
        register_page.enter_last_name(register_page.last_name)
    ...
    def test_password_confirmation(self, driver):
        register_page = RegisterPage(driver)
        register_page.open_page()
        register_page.enter_first_name(register_page.first_name)
        register_page.enter_last_name(register_page.last_name)
    ...
    @allure.story('View of password bar depending on password strength')
    def test_very_weak_password(self, driver):
        register_page = RegisterPage(driver)
        register_page.open_page()
    ...
    @allure.story('View of password bar depending on password strength')
    def test_medium_password(self, driver):
        register_page = RegisterPage(driver)
        register_page.open_page()
    ...
    @allure.story('View of password bar depending on password strength')
    def test_strong_password(self, driver):
        register_page = RegisterPage(driver)
        register_page.open_page()
    ...
    @allure.story('View of password bar depending on password strength')
    def test_very_strong_password(self, driver):
        register_page = RegisterPage(driver)
        register_page.open_page()
    ...
    def test_register_with_registered_email(self, driver):
        register_page = RegisterPage(driver)
        register_page.open_page()
        register_page.enter_first_name(register_page.first_name)
        register_page.enter_last_name(register_page.last_name)
